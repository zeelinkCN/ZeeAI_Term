...
> **想直接试用**：双击 `src-tauri/target/release/ZeeAI_Term.exe`。
...
`portable/ZeeAI_Term-0.1.0-portable.zip`（解压即用，内含内置 platform-tools，
...
- 安装包（NSIS）：`src-tauri/target/release/bundle/nsis/ZeeAI_Term_0.1.0_x64-setup.exe`
- 安装包（MSI）：`src-tauri/target/release/bundle/msi/ZeeAI_Term_0.1.0_x64_en-US.msi`
- 便携版：`portable/ZeeAI_Term-0.1.0-portable.zip`
